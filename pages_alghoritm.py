...
for paper in prepare_papers(number_of_pages):
    ...
    merged += 2
fff =["<html><body style='font-family:sans-serif; text-align:center; padding:50px;'><p><a href='{}' style='font-size:20px;'>Sheet to print: {}</a></p><br>".format(f,f) for f in created]
